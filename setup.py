...
def _get_version():
    ...
    with open(join(dirname(__file__), 'marvin_tumor_classification_engine/VERSION'), 'rb') as f:
...
setup(
    name='marvin_tumor_classification_engine',
    version=_get_version(),
    url='',
    description='Small tumor classification engine for tests propose only',
    long_description=open(join(dirname(__file__), 'README.md')).read(),
    author='Cerlio  Junior',
    maintainer='Cerlio  Junior',
    maintainer_email='cerliofaccojr@gmail.com',
